...
class Order(models.Model):
    ...
    exp_procedure = models.FileField(upload_to= custom_file_upload_path_exp, null=True, blank=True)
    risk_assessment = models.FileField(upload_to= custom_file_upload_path_risk, null=True, blank=True)
